                            ...
                            USART_OVS_TypeDef ovs)
{
   ...
   * ******This causes large errors for high baud rates **************
   * Since max processor freq =48M; max mutliplier = 89, use multipler 64
   * CLKDIV/4 = (256/4 * fHFPERCLK)/(oversample * br) - 256/4
   * CLKDIV/4 = (64 * fHFPERCLK)/(oversample * br) - 64
   */
   ...
   * than desired. */
  clkdiv  = (64 * refFreq) + ((oversample * baudrate) / 2);
