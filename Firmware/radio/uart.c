...
// Design Notes:
// -------------
// Adapted from the original for the Si1000's enhanced baudrate generator.
// _____________________________________________________________________________
//
static Bool setUartBaudRate(UartBaudRates baudRate)
{
	...
	{0xb0, 0x01},	// BAUD_RATE_38400
	{0x2b, 0x08},	// BAUD_RATE_57600
	{0x96, 0x08},	// BAUD_RATE_115200
	{0xcb, 0x08},	// BAUD_RATE_230400
    };
#else
# error No baud rate tables for selected clock
#endif

    if (baudRate == BAUD_RATE_NO_CHANGE)
	return 0;
    if (baudRate > NUM_BAUD_RATES)
	return 1;
    ...
    r_th1     = baud_rates[baudRate][0];
    r_ckcon   = (r_ckcon & ~0x0b) | baud_rates[baudRate][1];
    r_tconTr1 = 1;
