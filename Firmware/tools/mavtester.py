...
def send_telemetry():
    ...
    vehicle.mav.rc_channels_scaled_send(time_boot_ms=970855, port=0, chan1_scaled=280, chan2_scaled=3278, chan3_scaled=-3023, chan4_scaled=0, chan5_scaled=0, chan6_scaled=0, chan7_scaled=0, chan8_scaled=0, rssi=0)
    vehicle.mav.servo_output_raw_send(time_usec=967985041, port=0, servo1_raw=1470, servo2_raw=1628, servo3_raw=1479, servo4_raw=1506, servo5_raw=1500, servo6_raw=1556, servo7_raw=1500, servo8_raw=1500)
    vehicle.mav.rc_channels_raw_send(time_boot_ms=970935, port=0, chan1_raw=1470, chan2_raw=1618, chan3_raw=1440, chan4_raw=1509, chan5_raw=1168, chan6_raw=1556, chan7_raw=1224, chan8_raw=994, rssi=0)
    vehicle.mav.raw_imu_send(time_usec, 562, 382, -3917, -3330, 3445, 35, -24, 226, -523)
    vehicle.mav.scaled_pressure_send(time_boot_ms=970976, press_abs=950.770019531, press_diff=-0.0989062488079, temperature=463)
    ...
    vehicle.mav.gps_raw_int_send(time_usec=970833000, fix_type=3, lat=-353637616, lon=1491642012, alt=737900, eph=169, epv=65535, vel=2055, cog=34782, satellites_visible=9)
    ...
    vehicle.mav.attitude_send(time_boot_ms=970977, roll=0.00283912196755, pitch=-0.0538846850395, yaw=-0.0708072632551, rollspeed=0.226980209351, pitchspeed=-0.00743395090103, yawspeed=-0.154820173979)
