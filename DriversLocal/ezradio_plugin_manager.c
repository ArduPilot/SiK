...
void ezradioInit( EZRADIODRV_Handle_t handle,const uint8_t *Radio_Config_Data)
{
  ...
  ezradio_set_property(EZRADIO_PROP_GRP_ID_FRR_CTL, 4,EZRADIO_PROP_GRP_INDEX_FRR_CTL_A_MODE,
  		EZRADIO_PROP_FRR_CTL_A_MODE_FRR_A_MODE_ENUM_INT_PH_STATUS,
  		EZRADIO_PROP_FRR_CTL_B_MODE_FRR_B_MODE_ENUM_CURRENT_STATE,
  		EZRADIO_PROP_FRR_CTL_C_MODE_FRR_C_MODE_ENUM_LATCHED_RSSI,
  		EZRADIO_PROP_FRR_CTL_D_MODE_FRR_D_MODE_ENUM_DISABLED);
