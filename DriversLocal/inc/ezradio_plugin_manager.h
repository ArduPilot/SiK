...
/* Question: How to use my own radio configuartion header file?
 *
 * Answer (Simmplicity Studio): Simply open the bundled radio configurator
 * located in the RadioConfig source group. Whenever a new header file
 * is generted the project will reconfigure itself to use the generated
...
#define ECODE_EMDRV_EZRADIODRV_CHIP_ERROR 					( ECODE_EMDRV_EZRADIODRV_TRANSMIT_PLUGIN_BASE | 0x00000004 )
#define ECODE_EMDRV_EZRADIODRV_UF_OF_ERROR          ( ECODE_EMDRV_EZRADIODRV_TRANSMIT_PLUGIN_BASE | 0x00000008 )
#define ECODE_EMDRV_EZRADIODRV_STATE_CHANGE         ( ECODE_EMDRV_EZRADIODRV_TRANSMIT_PLUGIN_BASE | 0x00000010 )
...
/// options. Handler to this struct is passed to @ref ezradioInit() when
