...
// CHIP_HW_INTERRUPT = 0
#define RADIO_USER_INPUT_CHIP_HW_INTERRUPT 0
// CRC_PADDING = false
#define RADIO_USER_INPUT_CRC_PADDING FALSE
// CRC_START = true
#define RADIO_USER_INPUT_CRC_START TRUE
// CRYSTAL_CAP_BANK = 77
#define RADIO_USER_INPUT_CRYSTAL_CAP_BANK 77
...
// ENABLE_CHIP_HW_INTERRUPT = false
#define RADIO_USER_INPUT_ENABLE_CHIP_HW_INTERRUPT FALSE
// ENABLE_CRC[0] = true
#define RADIO_USER_INPUT_ENABLE_CRC[0] TRUE
// ENABLE_CRC[1] = true
#define RADIO_USER_INPUT_ENABLE_CRC[1] TRUE
// ENABLE_CRC[2] = true
#define RADIO_USER_INPUT_ENABLE_CRC[2] TRUE
// ENABLE_CRC[3] = false
...
// GPIO0 = 22
#define RADIO_USER_INPUT_GPIO0 22
// GPIO0_PULLUP = false
#define RADIO_USER_INPUT_GPIO0_PULLUP FALSE
// GPIO1 = 23
#define RADIO_USER_INPUT_GPIO1 23
// GPIO1_PULLUP = false
...
// GPIO3 = 32
#define RADIO_USER_INPUT_GPIO3 32
// GPIO3_PULLUP = false
...
// MATCH_BYTES = 2
#define RADIO_USER_INPUT_MATCH_BYTES 2
// MATCH_LOGIC[1] = AND
...
// MATCH_MASK[0] = FF
#define RADIO_USER_INPUT_MATCH_MASK[0] FF
// MATCH_MASK[1] = FF
#define RADIO_USER_INPUT_MATCH_MASK[1] FF
// MATCH_MASK[2] = 00
...
// MATCH_OFFSET[1] = 1
#define RADIO_USER_INPUT_MATCH_OFFSET[1] 1
// MATCH_OFFSET[2] = 1
#define RADIO_USER_INPUT_MATCH_OFFSET[2] 1
// MATCH_OFFSET[3] = 1
#define RADIO_USER_INPUT_MATCH_OFFSET[3] 1
...
// MATCH_VALUE[0] = 55
#define RADIO_USER_INPUT_MATCH_VALUE[0] 55
// MATCH_VALUE[1] = AA
#define RADIO_USER_INPUT_MATCH_VALUE[1] AA
// MATCH_VALUE[2] = 00
#define RADIO_USER_INPUT_MATCH_VALUE[2] 00
// MATCH_VALUE[3] = 00
#define RADIO_USER_INPUT_MATCH_VALUE[3] 00
// MODEM_HW_INTERRUPT = 2
#define RADIO_USER_INPUT_MODEM_HW_INTERRUPT 2
// NIRQ = 0
#define RADIO_USER_INPUT_NIRQ 0
// NIRQ_PULLUP = false
#define RADIO_USER_INPUT_NIRQ_PULLUP FALSE
// PACKET_HANDELR_HW_INTERRUPT = 25
#define RADIO_USER_INPUT_PACKET_HANDELR_HW_INTERRUPT 25
// PH_FIELD_SPLIT = true
...
// PKT_FIELD_CONTAINING_LENGTH = 2
#define RADIO_USER_INPUT_PKT_FIELD_CONTAINING_LENGTH 2
// PKT_FIELD_LENGTH[0] = 255
#define RADIO_USER_INPUT_PKT_FIELD_LENGTH[0] 255
...
// PKT_NUMBER_OF_RX_FIELDS = 3
#define RADIO_USER_INPUT_PKT_NUMBER_OF_RX_FIELDS 3
...
// PKT_PREAMBLE_RX_THRESHOLD = 24
#define RADIO_USER_INPUT_PKT_PREAMBLE_RX_THRESHOLD 24
...
// PKT_RX_FIELD_LENGTH[0] = 2
#define RADIO_USER_INPUT_PKT_RX_FIELD_LENGTH[0] 2
// PKT_RX_FIELD_LENGTH[1] = 1
#define RADIO_USER_INPUT_PKT_RX_FIELD_LENGTH[1] 1
// PKT_RX_FIELD_LENGTH[2] = 252
#define RADIO_USER_INPUT_PKT_RX_FIELD_LENGTH[2] 252
...
// PKT_RX_THRESHOLD = 32
#define RADIO_USER_INPUT_PKT_RX_THRESHOLD 32
...
// PKT_TX_THRESHOLD = 32
#define RADIO_USER_INPUT_PKT_TX_THRESHOLD 32
// PKT_VARIABLE_LENGTH_FIELD = 3
#define RADIO_USER_INPUT_PKT_VARIABLE_LENGTH_FIELD 3
...
// RFPARAM_4GFSK_MAP = 1
#define RADIO_USER_INPUT_RFPARAM_4GFSK_MAP 1
// RFPARAM_ADAPTIVE_CHFILL = false
#define RADIO_USER_INPUT_RFPARAM_ADAPTIVE_CHFILL FALSE
// RFPARAM_BANDWIDTH_TIME = 70
#define RADIO_USER_INPUT_RFPARAM_BANDWIDTH_TIME 70
...
// RFPARAM_DATA_RATE = 250000
#define RADIO_USER_INPUT_RFPARAM_DATA_RATE 250000
// RFPARAM_DEVIATION = 159000
#define RADIO_USER_INPUT_RFPARAM_DEVIATION 159000
...
// RFPARAM_ENABLEANTENNADIVERSITY = true
#define RADIO_USER_INPUT_RFPARAM_ENABLEANTENNADIVERSITY TRUE
...
// RX_CHECK_CRC[2] = true
#define RADIO_USER_INPUT_RX_CHECK_CRC[2] TRUE
...
// RX_ENABLE_CRC[2] = true
#define RADIO_USER_INPUT_RX_ENABLE_CRC[2] TRUE
...
// TRANSMIT_CRC[1] = false
#define RADIO_USER_INPUT_TRANSMIT_CRC[1] FALSE
// TRANSMIT_CRC[2] = true
#define RADIO_USER_INPUT_TRANSMIT_CRC[2] TRUE
...
// Pkt.PKT_RX_THRESHOLD__RX_THRESHOLD = 32
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_THRESHOLD__RX_THRESHOLD 32
// Global.GLOBAL_WUT_LDC__WUT_LDC = 0
#define CHIP_CONFIG_INPUT_GLOBAL_GLOBAL_WUT_LDC__WUT_LDC 0
// InterruptControl.INT_CTL_ENABLE__CHIP_INT_STATUS_EN = false
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_ENABLE__CHIP_INT_STATUS_EN FALSE
// Pkt.PKT_WHT_BIT_NUM__SW_WHT_CTRL = false
#define CHIP_CONFIG_INPUT_PKT_PKT_WHT_BIT_NUM__SW_WHT_CTRL FALSE
// Modem.API_Rsymb = 250000
#define CHIP_CONFIG_INPUT_MODEM_API_RSYMB 250000
...
// CrystalCapBank.value = 77
#define CHIP_CONFIG_INPUT_CRYSTALCAPBANK_VALUE 77
...
// Pkt.PKT_RX_FIELD_2_LENGTH__RX_FIELD_2_LENGTH = 1
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_2_LENGTH__RX_FIELD_2_LENGTH 1
...
// Pkt.PKT_RX_FIELD_1_LENGTH__RX_FIELD_1_LENGTH = 2
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_LENGTH__RX_FIELD_1_LENGTH 2
// Pkt.PKT_RX_FIELD_3_LENGTH__RX_FIELD_3_LENGTH = 252
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_3_LENGTH__RX_FIELD_3_LENGTH 252
...
// Pkt.PKT_FIELD_2_CRC_CONFIG__SEND_CRC = false
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_2_CRC_CONFIG__SEND_CRC FALSE
...
// ModemFsk4Map.value = 1
#define CHIP_CONFIG_INPUT_MODEMFSK4MAP_VALUE 1
// Pkt.PKT_RX_FIELD_1_CRC_CONFIG__CHECK_CRC = false
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_1_CRC_CONFIG__CHECK_CRC FALSE
// Pkt.PKT_FIELD_3_CRC_CONFIG__SEND_CRC = true
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_3_CRC_CONFIG__SEND_CRC TRUE
...
// Pkt.PKT_RX_FIELD_3_CRC_CONFIG__CHECK_CRC = true
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_3_CRC_CONFIG__CHECK_CRC TRUE
...
// Pkt.PKT_FIELD_3_CRC_CONFIG__CRC_ENABLE = true
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_3_CRC_CONFIG__CRC_ENABLE TRUE
// Modem.API_if_mode = 2
...
// Preamble.PREAMBLE_CONFIG_STD_1__RX_THRESH = 24
#define CHIP_CONFIG_INPUT_PREAMBLE_PREAMBLE_CONFIG_STD_1__RX_THRESH 24
...
// Pkt.PKT_TX_THRESHOLD__TX_THRESHOLD = 32
#define CHIP_CONFIG_INPUT_PKT_PKT_TX_THRESHOLD__TX_THRESHOLD 32
...
// Pkt.PKT_FIELD_1_LENGTH__FIELD_1_LENGTH = 255
#define CHIP_CONFIG_INPUT_PKT_PKT_FIELD_1_LENGTH__FIELD_1_LENGTH 255
...
// Modem.API_ant_div = true
#define CHIP_CONFIG_INPUT_MODEM_API_ANT_DIV TRUE
...
// Modem.API_Fdev = 159000
#define CHIP_CONFIG_INPUT_MODEM_API_FDEV 159000
// Pkt.PKT_RX_FIELD_3_CRC_CONFIG__CRC_ENABLE = true
#define CHIP_CONFIG_INPUT_PKT_PKT_RX_FIELD_3_CRC_CONFIG__CRC_ENABLE TRUE
...
// GpioPinCfg.gpio_mode = [22, 23, 33, 32]
#define CHIP_CONFIG_INPUT_GPIOPINCFG_GPIO_MODE "[22, 23, 33, 32]"
...
// InterruptControl.INT_CTL_PH_ENABLE__PACKET_SENT_EN = 0
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_PH_ENABLE__PACKET_SENT_EN 0
...
// InterruptControl.INT_CTL_CHIP_ENABLE__FIFO_UNDERFLOW_OVERFLOW_ERROR_EN = 0
#define CHIP_CONFIG_INPUT_INTERRUPTCONTROL_INT_CTL_CHIP_ENABLE__FIFO_UNDERFLOW_OVERFLOW_ERROR_EN 0
...
// Pkt.PKT_LEN__DST_FIELD = 3
#define CHIP_CONFIG_INPUT_PKT_PKT_LEN__DST_FIELD 3
// Pkt.PKT_LEN_FIELD_SOURCE__SRC_FIELD = 2
#define CHIP_CONFIG_INPUT_PKT_PKT_LEN_FIELD_SOURCE__SRC_FIELD 2
// Pkt.PKT_LEN__SIZE = 0
...
// Match.MATCH_CTRL_4__LOGIC = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_4__LOGIC 0
// Match.MATCH_CTRL_4__OFFSET = 1
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_4__OFFSET 1
// Match.MATCH_CTRL_4__POLARITY = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_4__POLARITY 0
// Match.MATCH_MASK_4__MASK_4 = -1
#define CHIP_CONFIG_INPUT_MATCH_MATCH_MASK_4__MASK_4 -1
// Match.MATCH_VALUE_4__VALUE_4 = -86
#define CHIP_CONFIG_INPUT_MATCH_MATCH_VALUE_4__VALUE_4 -86
// Match.MATCH_CTRL_3__LOGIC = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_3__LOGIC 0
// Match.MATCH_CTRL_3__OFFSET = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_3__OFFSET 0
// Match.MATCH_CTRL_3__POLARITY = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_3__POLARITY 0
// Match.MATCH_MASK_3__MASK_3 = -1
#define CHIP_CONFIG_INPUT_MATCH_MATCH_MASK_3__MASK_3 -1
// Match.MATCH_VALUE_3__VALUE_3 = 85
#define CHIP_CONFIG_INPUT_MATCH_MATCH_VALUE_3__VALUE_3 85
// Match.MATCH_CTRL_2__LOGIC = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_2__LOGIC 0
// Match.MATCH_CTRL_2__OFFSET = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_2__OFFSET 0
// Match.MATCH_CTRL_2__POLARITY = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_2__POLARITY 0
// Match.MATCH_MASK_2__MASK_2 = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_MASK_2__MASK_2 0
// Match.MATCH_VALUE_2__VALUE_2 = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_VALUE_2__VALUE_2 0
// Match.MATCH_CTRL_1__MATCH_EN = 1
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_1__MATCH_EN 1
// Match.MATCH_CTRL_1__OFFSET = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_1__OFFSET 0
// Match.MATCH_CTRL_1__POLARITY = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_CTRL_1__POLARITY 0
// Match.MATCH_MASK_1__MASK_1 = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_MASK_1__MASK_1 0
// Match.MATCH_VALUE_1__VALUE_1 = 0
#define CHIP_CONFIG_INPUT_MATCH_MATCH_VALUE_1__VALUE_1 0
...
// BandwidthTime.value = 0.7
#define CHIP_CONFIG_INPUT_BANDWIDTHTIME_VALUE 0.7
// Modem.API_dsource = 0
