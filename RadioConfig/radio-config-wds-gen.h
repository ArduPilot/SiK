...
#define RADIO_CONFIGURATION_DATA_RADIO_PACKET_LENGTH (255)
...
#define RF_GPIO_PIN_CFG 0x13, 0x16, 0x17, 0x21, 0x20, 0x00, 0x00, 0x00

#define RF_SET_PROPERTY_GLOBAL_XO_TUNE 0x11, 0x00, 0x01, 0x00, 0x4D
...
#define RF_SET_PROPERTY_INT_CTL_ENABLE 0x11, 0x01, 0x01, 0x00, 0x03

#define RF_SET_PROPERTY_INT_CTL_PH_ENABLE 0x11, 0x01, 0x01, 0x01, 0x19

#define RF_SET_PROPERTY_INT_CTL_MODEM_ENABLE 0x11, 0x01, 0x01, 0x02, 0x02
...
#define RF_SET_PROPERTY_PREAMBLE_CONFIG_STD_1 0x11, 0x10, 0x01, 0x01, 0x18
...
#define RF_SET_PROPERTY_PKT_LEN 0x11, 0x12, 0x01, 0x08, 0x2B

#define RF_SET_PROPERTY_PKT_LEN_FIELD_SOURCE 0x11, 0x12, 0x01, 0x09, 0x02

#define RF_SET_PROPERTY_PKT_LEN_ADJUST 0x11, 0x12, 0x01, 0x0A, 0x00

#define RF_SET_PROPERTY_PKT_TX_THRESHOLD 0x11, 0x12, 0x01, 0x0B, 0x20

#define RF_SET_PROPERTY_PKT_RX_THRESHOLD 0x11, 0x12, 0x01, 0x0C, 0x20

#define RF_SET_PROPERTY_PKT_FIELD_1_LENGTH 0x11, 0x12, 0x02, 0x0D, 0x00, 0xFF
...
#define RF_SET_PROPERTY_PKT_FIELD_2_CRC_CONFIG 0x11, 0x12, 0x01, 0x14, 0x0A
...
#define RF_SET_PROPERTY_PKT_FIELD_3_CRC_CONFIG 0x11, 0x12, 0x01, 0x18, 0x22
...
#define RF_SET_PROPERTY_PKT_RX_FIELD_1_LENGTH 0x11, 0x12, 0x02, 0x21, 0x00, 0x02
...
#define RF_SET_PROPERTY_PKT_RX_FIELD_2_LENGTH 0x11, 0x12, 0x02, 0x25, 0x00, 0x01

#define RF_SET_PROPERTY_PKT_RX_FIELD_2_CONFIG 0x11, 0x12, 0x01, 0x27, 0x00

#define RF_SET_PROPERTY_PKT_RX_FIELD_2_CRC_CONFIG 0x11, 0x12, 0x01, 0x28, 0x02

#define RF_SET_PROPERTY_PKT_RX_FIELD_3_LENGTH 0x11, 0x12, 0x02, 0x29, 0x00, 0xFC

#define RF_SET_PROPERTY_PKT_RX_FIELD_3_CONFIG 0x11, 0x12, 0x01, 0x2B, 0x00

#define RF_SET_PROPERTY_PKT_RX_FIELD_3_CRC_CONFIG 0x11, 0x12, 0x01, 0x2C, 0x0A
...
#define RF_SET_PROPERTY_MATCH_CTRL_1 0x11, 0x30, 0x01, 0x02, 0x40
...
#define RF_SET_PROPERTY_MATCH_MASK_3 0x11, 0x30, 0x01, 0x07, 0xFF
...
#define RF_SET_PROPERTY_MATCH_MASK_4 0x11, 0x30, 0x01, 0x0A, 0xFF

#define RF_SET_PROPERTY_MATCH_CTRL_4 0x11, 0x30, 0x01, 0x0B, 0x01

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_8 0x11, 0x20, 0x01, 0x0F, 0x48

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_7 0x11, 0x20, 0x01, 0x10, 0x3F

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_6 0x11, 0x20, 0x01, 0x11, 0x29

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_5 0x11, 0x20, 0x01, 0x12, 0x14

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_4 0x11, 0x20, 0x01, 0x13, 0x08

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_3 0x11, 0x20, 0x01, 0x14, 0x02

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_2 0x11, 0x20, 0x01, 0x15, 0x00

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_1 0x11, 0x20, 0x01, 0x16, 0x00

#define RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_0 0x11, 0x20, 0x01, 0x17, 0x00

#define RF_SET_PROPERTY_MODEM_MOD_TYPE 0x11, 0x20, 0x01, 0x00, 0x03
...
#define RF_SET_PROPERTY_SYNTH_PFDCP_CPFF 0x11, 0x23, 0x01, 0x00, 0x01

#define RF_SET_PROPERTY_SYNTH_PFDCP_CPINT 0x11, 0x23, 0x01, 0x01, 0x05

#define RF_SET_PROPERTY_SYNTH_VCO_KV 0x11, 0x23, 0x01, 0x02, 0x0B

#define RF_SET_PROPERTY_SYNTH_LPFILT3 0x11, 0x23, 0x01, 0x03, 0x05

#define RF_SET_PROPERTY_SYNTH_LPFILT2 0x11, 0x23, 0x01, 0x04, 0x02

#define RF_SET_PROPERTY_SYNTH_LPFILT1 0x11, 0x23, 0x01, 0x05, 0x00

#define RF_SET_PROPERTY_SYNTH_LPFILT0 0x11, 0x23, 0x01, 0x06, 0x03

#define RF_SET_PROPERTY_MODEM_DATA_RATE 0x11, 0x20, 0x03, 0x03, 0x26, 0x25, 0xA0

#define RF_SET_PROPERTY_MODEM_TX_NCO_MODE 0x11, 0x20, 0x04, 0x06, 0x01, 0xC9, 0xC3, 0x80

#define RF_SET_PROPERTY_MODEM_FREQ_DEV 0x11, 0x20, 0x03, 0x0A, 0x00, 0x2B, 0x6A
...
#define RF_SET_PROPERTY_MODEM_DECIMATION_CFG1 0x11, 0x20, 0x01, 0x1E, 0x00

#define RF_SET_PROPERTY_MODEM_DECIMATION_CFG0 0x11, 0x20, 0x01, 0x1F, 0x30

#define RF_SET_PROPERTY_MODEM_BCR_OSR 0x11, 0x20, 0x02, 0x22, 0x00, 0x78

#define RF_SET_PROPERTY_MODEM_BCR_NCO_OFFSET 0x11, 0x20, 0x03, 0x24, 0x04, 0x44, 0x44

#define RF_SET_PROPERTY_MODEM_BCR_GAIN 0x11, 0x20, 0x02, 0x27, 0x01, 0xAD
...
#define RF_SET_PROPERTY_MODEM_AFC_GAIN 0x11, 0x20, 0x02, 0x2E, 0x88, 0x89

#define RF_SET_PROPERTY_MODEM_AFC_LIMITER 0x11, 0x20, 0x02, 0x30, 0x00, 0xF3

#define RF_SET_PROPERTY_MODEM_AFC_MISC 0x11, 0x20, 0x01, 0x32, 0xA0

#define RF_SET_PROPERTY_MODEM_AGC_CONTROL 0x11, 0x20, 0x01, 0x35, 0xE2

#define RF_SET_PROPERTY_MODEM_AGC_WINDOW_SIZE 0x11, 0x20, 0x01, 0x38, 0x22

#define RF_SET_PROPERTY_MODEM_AGC_RFPD_DECAY 0x11, 0x20, 0x01, 0x39, 0x0D

#define RF_SET_PROPERTY_MODEM_AGC_IFPD_DECAY 0x11, 0x20, 0x01, 0x3A, 0x0D
...
#define RF_SET_PROPERTY_MODEM_FSK4_TH 0x11, 0x20, 0x02, 0x3D, 0x51, 0x68
...
#define RF_SET_PROPERTY_MODEM_RAW_EYE 0x11, 0x20, 0x02, 0x46, 0x00, 0xDC

#define RF_SET_PROPERTY_MODEM_ANT_DIV_MODE 0x11, 0x20, 0x01, 0x48, 0x02

#define RF_SET_PROPERTY_MODEM_ANT_DIV_CONTROL 0x11, 0x20, 0x01, 0x49, 0x04

#define RF_SET_PROPERTY_MODEM_RSSI_JUMP_THRESH 0x11, 0x20, 0x01, 0x4B, 0x08
...
#define RF_SET_PROPERTY_MODEM_CHFLT_RX1_CHFLT_COE_0 0x11, 0x21, 0x0C, 0x00, 0x7E, 0x64, 0x1B, 0xBA, 0x58, 0x0B, 0xDD, 0xCE, 0xD6, 0xE6, 0xF6, 0x00

#define RF_SET_PROPERTY_MODEM_CHFLT_RX1_CHFLT_COE_1 0x11, 0x21, 0x06, 0x0C, 0x03, 0x03, 0x15, 0xF0, 0x3F, 0x00

#define RF_SET_PROPERTY_MODEM_CHFLT_RX2_CHFLT_COE_0 0x11, 0x21, 0x0C, 0x12, 0x7E, 0x64, 0x1B, 0xBA, 0x58, 0x0B, 0xDD, 0xCE, 0xD6, 0xE6, 0xF6, 0x00

#define RF_SET_PROPERTY_MODEM_CHFLT_RX2_CHFLT_COE_1 0x11, 0x21, 0x06, 0x1E, 0x03, 0x03, 0x15, 0xF0, 0x3F, 0x00
...
#define RF_SET_PROPERTY_MODEM_ONE_SHOT_AFC 0x11, 0x20, 0x01, 0x55, 0x01
...
#define RADIO_CONFIGURATION_DATA_ARRAY {\
  ...
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_8, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_7, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_6, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_5, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_4, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_3, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_2, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_1, \
  5, RF_SET_PROPERTY_MODEM_TX_FILTER_COEFF_0, \
...
#define RADIO_CONFIGURATION_DATA_CRYSTAL_CAP_BANK 77
...
#define RADIO_CONFIGURATION_DATA_ENABLE_CRC_2 TRUE
#define RADIO_CONFIGURATION_DATA_ENABLE_CRC_3 FALSE
#define RADIO_CONFIGURATION_DATA_ENABLE_CRC_4 FALSE
#define RADIO_CONFIGURATION_DATA_ENABLE_MODEM_HW_INTERRUPT TRUE
...
#define RADIO_CONFIGURATION_DATA_GPIO0 22
#define RADIO_CONFIGURATION_DATA_GPIO0_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_GPIO1 23
...
#define RADIO_CONFIGURATION_DATA_GPIO3 32
...
#define RADIO_CONFIGURATION_DATA_MATCH_BYTES 2
...
#define RADIO_CONFIGURATION_DATA_MATCH_MASK_0 FF
#define RADIO_CONFIGURATION_DATA_MATCH_MASK_1 FF
...
#define RADIO_CONFIGURATION_DATA_MATCH_OFFSET_1 1
#define RADIO_CONFIGURATION_DATA_MATCH_OFFSET_2 1
#define RADIO_CONFIGURATION_DATA_MATCH_OFFSET_3 1
...
#define RADIO_CONFIGURATION_DATA_MATCH_VALUE_0 55
#define RADIO_CONFIGURATION_DATA_MATCH_VALUE_1 AA
#define RADIO_CONFIGURATION_DATA_MATCH_VALUE_2 00
#define RADIO_CONFIGURATION_DATA_MATCH_VALUE_3 00
#define RADIO_CONFIGURATION_DATA_MODEM_HW_INTERRUPT 2
#define RADIO_CONFIGURATION_DATA_NIRQ 0
#define RADIO_CONFIGURATION_DATA_NIRQ_PULLUP FALSE
#define RADIO_CONFIGURATION_DATA_PACKET_HANDELR_HW_INTERRUPT 25
...
#define RADIO_CONFIGURATION_DATA_PKT_FIELD_CONTAINING_LENGTH 2
#define RADIO_CONFIGURATION_DATA_PKT_FIELD_LENGTH_0 255
...
#define RADIO_CONFIGURATION_DATA_PKT_NUMBER_OF_RX_FIELDS 3
...
#define RADIO_CONFIGURATION_DATA_PKT_PREAMBLE_RX_THRESHOLD 24
...
#define RADIO_CONFIGURATION_DATA_PKT_RX_FIELD_LENGTH_0 2
#define RADIO_CONFIGURATION_DATA_PKT_RX_FIELD_LENGTH_1 1
#define RADIO_CONFIGURATION_DATA_PKT_RX_FIELD_LENGTH_2 252
...
#define RADIO_CONFIGURATION_DATA_PKT_RX_THRESHOLD 65
...
#define RADIO_CONFIGURATION_DATA_PKT_TX_THRESHOLD 65
#define RADIO_CONFIGURATION_DATA_PKT_VARIABLE_LENGTH_FIELD 3
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_4GFSK_MAP 1
#define RADIO_CONFIGURATION_DATA_RFPARAM_ADAPTIVE_CHFILL FALSE
#define RADIO_CONFIGURATION_DATA_RFPARAM_BANDWIDTH_TIME 70
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_DATA_RATE 250000
#define RADIO_CONFIGURATION_DATA_RFPARAM_DEVIATION 159000
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_ENABLEANTENNADIVERSITY TRUE
...
#define RADIO_CONFIGURATION_DATA_RFPARAM_RSSI_AVERAGE 2
...
#define RADIO_CONFIGURATION_DATA_RX_CHECK_CRC_2 TRUE
...
#define RADIO_CONFIGURATION_DATA_RX_ENABLE_CRC_2 TRUE
...
#define RADIO_CONFIGURATION_DATA_TRANSMIT_CRC_1 FALSE
#define RADIO_CONFIGURATION_DATA_TRANSMIT_CRC_2 TRUE
